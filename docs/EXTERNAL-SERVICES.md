...
| Google Cloud                                                         | OAuth clients for Google sign-in                             | Roch (join.leq@gmail.com)                          | Web and iOS clients created 2026-09-13; consent screen still in Testing                              | n/a                                              | Google terms                           |
...
- Status: both created on 2026-09-13 under join.leq@gmail.com, project "LEQ App". The consent screen is in Testing, which limits sign-in to listed test users: publish it, or list each tester, before anyone else tries the button. Android will need a third client with the SHA-1 of the signing key.
