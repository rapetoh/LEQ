...
- One recovery per month (`recuperations_serie_par_mois`), activated by the person, covers exactly one missed day: yesterday, when the last active day is the day before. A gap of two days or more is a broken streak; that fragility is the mechanism (chapter 6).
