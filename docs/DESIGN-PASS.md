...
La maquette est le plancher : chaque écran construit doit l'égaler ou faire un peu mieux. Relevé par un lecteur indépendant sur les écrans construits jusqu'à la Phase 6. Une ligne est cochée quand la correction est faite et vue sur le simulateur.

- [ ] **X3 (et A5/X2, même composant)** (manque) `apps/mobile/src/components/EcranAnalyse.tsx`  
...
- [ ] **G3** (manque) `apps/mobile/src/app/reglages.tsx`  
...
- [ ] **B1** (manque) `apps/mobile/src/app/(onglets)/aujourdhui.tsx`  
...
- [ ] **G1** (manque) `apps/mobile/src/app/(onglets)/moi.tsx`  
...
- [ ] **B3** (manque) `apps/mobile/src/app/defi/[etapeId]/index.tsx`  
...
- [ ] **H2** (manque) `apps/mobile/src/app/retour/[tentativeId].tsx`  
...
- [ ] **X2 (et A5)** (manque) `apps/mobile/src/components/EcranAnalyse.tsx`  
...
- [ ] **A4** (moins_bien) `apps/mobile/src/app/accueil/prise.tsx`  
...
- [ ] **B1** (moins_bien) `apps/mobile/src/app/(onglets)/aujourdhui.tsx`  
...
- [ ] **B3** (detail) `apps/mobile/src/app/defi/[etapeId]/index.tsx`  
...
- [ ] **B5, B5b, H2** (detail) `apps/mobile/src/components/TuilesMesures.tsx`  
...
- [ ] **G3** (detail) `apps/mobile/src/app/reglages.tsx`  
