...
export const fr = {
  ...
  arene: {
    ...
    ecouter: 'Écouter',
    ecouterVoix: 'Écouter la voix {{lettre}}',
    ou: 'ou',
  ...
  duel: {
    ...
    contre: 'Contre {{nom}}',
    sansAdversaire: "En attente d'un·e adversaire",
    ...
    ligne: {
      ...
      aRepondu: '{{nom}} a répondu · à toi de parler',
    ...
    sujetAide: 'Chacun parle de son côté. 48 h pour répondre.',
    creer: 'Créer le duel',
    ...
    toi: 'Toi',
    aParle: 'A parlé',
    pasEncoreParle: 'Pas encore parlé',
    vainqueur: 'Vainqueur',
    invitationTitre: "Personne n'a encore rejoint le duel.",
    invitationCorps: "Envoie l'invitation. Le lien fonctionne même sans l'application.",
    envoyerInvitation: "Envoyer l'invitation",
    copierLien: 'Copier le lien',
    lienCopie: 'Lien copié.',
    messageInvitation: 'Je te défie sur LEQ : « {{sujet}} ». Tu as 48 h pour répondre : {{lien}}',
    aToiTitre: 'À toi de parler',
    aToiCorpsRepondu: 'Tu entendras la réponse de {{nom}} après la tienne.',
    aToiCorpsAttente: "{{nom}} n'a pas encore parlé.",
    attenteTitre: 'Ta réponse est envoyée',
    attenteCorps: 'Le verdict arrive dès que {{nom}} aura parlé.',
    attenteCorpsSansAdversaire: 'Le verdict arrive quand la personne invitée aura parlé.',
    ...
    sansVerdictCorps: "La grille de Rebecca n'est pas encore en place. Ce duel reste sans verdict.",
