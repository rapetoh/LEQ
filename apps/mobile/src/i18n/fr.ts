...
export const fr = {
  ...
  reglages: {
    ...
    voix: {
      ...
      publierPrenomDetail: "Sinon : anonyme dans l'Arène, sous un numéro",
  ...
  arene: {
    ...
    passageDetail:
      'Réécoutable et retirable tant que le sujet est ouvert. Pas de seconde version : tu as entendu les autres.',
    ...
    aucunSujetCorps:
      'Le prochain sujet arrive avec Rebecca. En attendant, ton défi du jour reste ouvert.',
    parleDAbordTitre: "Parle d'abord.",
    parleDAbordCorps:
      "Les passages des autres restent voilés tant que tu n'as pas parlé. Sinon tout le monde s'aligne sur la première bonne réponse entendue.",
    rienAComparerTitre: 'Tu as tout écouté.',
    rienAComparerCorps: "Reviens quand d'autres auront parlé : il y aura de nouvelles paires.",
    ...
    duelSujet: 'Le sujet',
    duelSujetAide: 'Écris-le. La banque de sujets de Rebecca arrive avec elle.',
    duelCreer: 'Créer le duel',
    duelLien: "Le lien d'invitation",
    duelLienAide: "Envoie-le à la personne. Il marche même si elle n'a pas l'application.",
    ...
    podiumPasDeVoix: 'Aucune voix cette fois. La semaine prochaine, tu recommences.',
    podiumPasParle: "Tu n'as pas parlé cette semaine.",
    podiumPasParleCorps: 'Le sujet suivant est déjà ouvert. Prends ta place dedans.',
