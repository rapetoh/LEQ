...
export default defineConfig([
  ...
  // Application code: typed linting through the TypeScript project service.
  {
    ...
    rules: {
      // French typography needs the no-break space (U+00A0) and the narrow no-break space
      // (U+202F) before ":", "?", "!" and before a unit. They are legitimate characters here,
      // in plain strings as in template literals.
