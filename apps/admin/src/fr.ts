...
export const fr = {
  ...
  defis: {
    ...
    dupliquer: 'Dupliquer',
    dupliquerTitre: 'Dupliquer le défi',
    dupliquerIntro: (titre: string) =>
      `Dans quel acte copier \u00ab\u202f${titre}\u202f\u00bb\u202f?`,
    duplique: (titre: string) =>
      `\u00ab\u202f${titre}\u202f\u00bb est copié. Modifie la copie à ta main.`,
  ...
  moderation: {
    ...
    transcriptionVide: 'Aucun mot transcrit.',
    filtre: 'Le contrôle automatique',
    filtreRas: 'Aucun signalement',
    nonFiltree: 'Non contrôlée',
    motifs: {
      sexuel: 'Contenu sexuel',
      harcelement: 'Harcèlement',
      haine: 'Haine',
      violence: 'Violence',
      automutilation: 'Mise en danger de soi',
